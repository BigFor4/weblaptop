...
<div class="header-w3l">
    <h1>NONAME QUÊN MẬT KHẨU FORM</h1>
</div>
...
<div class="main-content-agile">
    <div class="sub-main-w3">	
        ...
        <form method="post" id="create">
            <div class="pom-agile">
                <input class="user" type="text" placeholder="Email User" name="email" >
            ...
            <div id="alert"></div>  
            <button  class="btn btn-primary" style="margin-top: 20px;">Send Email</button>
...
<script type="text/javascript">
		$("#create").submit(function(e){
            ...
            if(count==0)
            {
                $("#alert").html('<strong class="text-danger">Không tồn tại email này</strong>'); 
			...
			else
			{
                ...
                const url = $(this).attr("action");
				        ...
				        success: function (data) {
				        	alert("Nhận mật khẩu mới ở email");
                            window.location="index.php?controller=user&action=dangnhap";
				        },
				   		});		   
