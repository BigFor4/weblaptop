              ...
              <div class="card" style="margin-top:100px;">
                ...
                <nav aria-label="Page navigation example" id="pageCurrent">
                        <ul class="pagination pageCurrent" id="mainData">
                            <?php
                            echo '<li class="page-item"><a class="page-link" href="?controller=laptop&action=list&page=' . $curent_pagePrevious . '">Trước</a></li>';
                            for ($i = 1; $i <= $pages; $i++) {
                                echo ' <li class="page-item"><a class="page-link" href="?controller=laptop&action=list&page=' . $i . '">' . $i . '</a></li>';
                            }
                            echo ' <li class="page-item"><a class="page-link" href="?controller=laptop&action=list&page=' . $curent_pageNext . '">Sau</a></li>';
                            ?>
                        </ul>
                    </nav>
              </div>
