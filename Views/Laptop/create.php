                       	...
                       	<div class="row" >
                        	...
                        	<div class="col-md-3">
                        		<div class="form-group">
                                  ...
                                  <input id="cpu"  type="text" class="form-control" name="cpu"  placeholder="Enter CPU" >
                               </div>
                        	</div>
                        	<div class="col-md-3">
                        		<div class="form-group">
                                  <label style="font-size:20px;color:black;">Màn Hình<span class="text-danger">*</span></label>
                                  <input id="manhinh"  type="text" class="form-control" name="manhinh"  placeholder="Enter Man Hinh">
                               </div>
                        	</div>       
                        	<div class="col-md-3">
                        		<div class="form-group">
                                  <label style="font-size:20px;color:black;">Card<span class="text-danger">*</span></label>
                                  <input id="card"  type="text" class="form-control" name="card"  placeholder="Enter Card" >
                               </div>
                        	</div>
                        	<div class="col-md-3">
                        		<div class="form-group">
                                  <label style="font-size:20px;color:black;">Trọng lượng<span class="text-danger">*</span></label>
                                  <input id="trongluong"  type="text" class="form-control" name="trongluong"  placeholder="Enter Trọng Lượng">
                               </div>
                        	</div>        
                        	 <div class="col-md-3">
                        		<div class="form-group">
                                  <label style="font-size:20px;color:black;">Kich thuoc<span class="text-danger">*</span></label>
                                  <input id="kichthuoc"  type="text" class="form-control" name="kichthuoc"  placeholder="Enter Kích Thước">
                               </div>
                        	</div>     
                        	<div class="col-md-3">
                        		<div class="form-group">
                        	...
                        	<div class="col-md-6">
                        	 ...
                        	 <div class="col-md-3">
                        		<div class="form-group">
                                  ...
                                  <input id="price"  type="text" class="form-control" name="price"  placeholder="Enter Giá Tiền">
                               </div>
                        	</div>      
                        	 <div class="col-md-6">
                        		<div class="form-group">
                                  <label style="font-size:20px;color:black;">Thông tin khác</label>
                                  <textarea id="thongtinkhac"  type="text" class="form-control" name="thongtinkhac"  placeholder="Enter Thông tin khác" ></textarea>  
                               </div>
                        	</div>
                          <div class="col-md-6">
                        		<div class="form-group">
                                  <label style="font-size:20px;color:black;">Image<span class="text-danger">*</span></label>
                                  <input id="image"  type="url" class="form-control" name="image"  placeholder="Enter image" >
                               </div>
                        	</div>
                        </div>	       
                        <div id="alert"></div>             
...
<script type="text/javascript">
		$("#create").submit(function(e){
			...
			let thongtinkhac = $("textarea[name='thongtinkhac']").val();
			...
			else if(thongtinkhac == null || thongtinkhac == "")
			{
				...
				$("textarea[name='thongtinkhac']").focus();
				return;
			}
            ...
            const formData = new FormData(this);
                    ...
                    alert("Thêm mới thành công");
				        	  window.location.replace("index.php?controller=laptop&action=list");       
